...
def generate_launch_description():
  ...
  servicecall = ExecuteProcess(
       cmd=[[
            FindExecutable(name='ros2'),
            " service call ",
            "/datum ",
            "robot_localization/srv/SetDatum ",
            '"{geo_pose: {position: {latitude: 51.989545, longitude: 5.947526, altitude: 13.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}}"',
        ]],
        
        output='screen',
    )
  
  ld.add_action(servicecall)
