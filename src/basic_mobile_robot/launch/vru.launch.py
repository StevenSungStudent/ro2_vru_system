...
##ros2 run mavros mavros_node --ros-args --param fcu_url:=/dev/ttyACM0:57600  -r tf:=/px4/tf  -r tf_static:=/px4/tf_static 
...
def generate_launch_description():
  ...
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/nxp.rviz')
