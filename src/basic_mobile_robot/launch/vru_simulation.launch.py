...
USE_AMCL = 1
def set_origin():
  os.system("ros2 service call /datum robot_localization/srv/SetDatum '{geo_pose: {position: {latitude: 51.98969350036926, longitude: 5.949716200007323, altitude: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}}'")
...
def generate_launch_description():
  ...
  robot_localization_file_path = os.path.join(pkg_share, 'config/ekf_gps.yaml') 
